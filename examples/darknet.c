...
#ifdef OPENCL
    clPlatform=(cl_platform_id*)malloc(sizeof(cl_platform_id));
    clDevice=(cl_device_id*)malloc(sizeof(cl_device_id));
    clContext=(cl_context*)malloc(sizeof(cl_context));
    clCommandQueue=(cl_command_queue*)malloc(sizeof(cl_command_queue));
    clProgram=(cl_program*)malloc(sizeof(cl_program));
    clKernel=(cl_kernel*)malloc(sizeof(cl_kernel));
    if(0!=CreateTool(clPlatform,clDevice,clContext,clCommandQueue,clProgram,"src/opencl_kernel.cl"))
    {
