...
void forward_lstm_layer_cl(layer l, network state)
{
    ...
    fill_cl(l.outputs * l.batch * l.steps, 0, wf.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, wi.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, wg.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, wo.delta_cl, 1,0);

    fill_cl(l.outputs * l.batch * l.steps, 0, uf.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, ui.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, ug.delta_cl, 1,0);
    fill_cl(l.outputs * l.batch * l.steps, 0, uo.delta_cl, 1,0);
    if (state.train) {
    ...
    for (i = 0; i < l.steps; ++i) {
        ...
        copy_cl(l.outputs*l.batch, wf.output_cl, 1, l.f_cl, 1,0,0);
        axpy_cl(l.outputs*l.batch, 1, uf.output_cl, 1, l.f_cl, 1,0,0);

        copy_cl(l.outputs*l.batch, wi.output_cl, 1, l.i_cl, 1,0,0);	
        axpy_cl(l.outputs*l.batch, 1, ui.output_cl, 1, l.i_cl, 1,0,0);	

        copy_cl(l.outputs*l.batch, wg.output_cl, 1, l.g_cl, 1,0,0);	
        axpy_cl(l.outputs*l.batch, 1, ug.output_cl, 1, l.g_cl, 1,0,0);	

        copy_cl(l.outputs*l.batch, wo.output_cl, 1, l.o_cl, 1,0,0);	
        axpy_cl(l.outputs*l.batch, 1, uo.output_cl, 1, l.o_cl, 1,0,0);	

        activate_array_cl(l.f_cl, l.outputs*l.batch, LOGISTIC,0);		
        activate_array_cl(l.i_cl, l.outputs*l.batch, LOGISTIC,0);		
        activate_array_cl(l.g_cl, l.outputs*l.batch, TANH,0);			
        activate_array_cl(l.o_cl, l.outputs*l.batch, LOGISTIC,0);		

        copy_cl(l.outputs*l.batch, l.i_cl, 1, l.temp_cl, 1,0,0);		
        mul_cl(l.outputs*l.batch, l.g_cl, 1, l.temp_cl, 1,0,0);		
        mul_cl(l.outputs*l.batch, l.f_cl, 1, l.c_cl, 1,0,0);			
        axpy_cl(l.outputs*l.batch, 1, l.temp_cl, 1, l.c_cl, 1,0,0);	

        copy_cl(l.outputs*l.batch, l.c_cl, 1, l.h_cl, 1,0,0);			
        activate_array_cl(l.h_cl, l.outputs*l.batch, TANH,0);		
        mul_cl(l.outputs*l.batch, l.o_cl, 1, l.h_cl, 1,0,0);	

        copy_cl(l.outputs*l.batch, l.c_cl, 1, l.cell_cl, 1,0,0);		
        copy_cl(l.outputs*l.batch, l.h_cl, 1, l.output_cl, 1,0,0);
...
void backward_lstm_layer_cl(layer l, network state)
{
    ...
    for (i = l.steps - 1; i >= 0; --i) {
        if (i != 0) copy_cl(l.outputs*l.batch, l.cell_cl, 1, l.prev_cell_cl, 1,-l.outputs*l.batch,0);
        copy_cl(l.outputs*l.batch, l.cell_cl, 1, l.c_cl, 1,0,0);
        if (i != 0) copy_cl(l.outputs*l.batch, l.output_cl, 1, l.prev_state_cl, 1,-l.outputs*l.batch,0);
        copy_cl(l.outputs*l.batch, l.output_cl, 1, l.h_cl, 1,0,0);
        ...
        copy_cl(l.outputs*l.batch, l.delta_cl, 1, l.temp3_cl, 1,0,0);		

        copy_cl(l.outputs*l.batch, l.c_cl, 1, l.temp_cl, 1,0,0);			
        activate_array_cl(l.temp_cl, l.outputs*l.batch, TANH,0);			

        copy_cl(l.outputs*l.batch, l.temp3_cl, 1, l.temp2_cl, 1,0,0);		
        mul_cl(l.outputs*l.batch, l.o_cl, 1, l.temp2_cl, 1,0,0);			

        gradient_array_cl(l.temp_cl, l.outputs*l.batch, TANH, l.temp2_cl,0,0);
        axpy_cl(l.outputs*l.batch, 1, l.dc_cl, 1, l.temp2_cl, 1,0,0);		

        copy_cl(l.outputs*l.batch, l.c_cl, 1, l.temp_cl, 1,0,0);			
        activate_array_cl(l.temp_cl, l.outputs*l.batch, TANH,0);			
        mul_cl(l.outputs*l.batch, l.temp3_cl, 1, l.temp_cl, 1,0,0);		
        gradient_array_cl(l.o_cl, l.outputs*l.batch, LOGISTIC, l.temp_cl,0,0);
        copy_cl(l.outputs*l.batch, l.temp_cl, 1, wo.delta_cl, 1,0,0);
        s.input_cl = l.prev_state_cl;
        s.delta_cl = l.dh_cl;															
        backward_connected_layer_cl(wo, s);	

        copy_cl(l.outputs*l.batch, l.temp_cl, 1, uo.delta_cl, 1,0,0);
        s.input_cl = state.input_cl;
        s.delta_cl = state.delta_cl;
        backward_connected_layer_cl(uo, s);									

        copy_cl(l.outputs*l.batch, l.temp2_cl, 1, l.temp_cl, 1,0,0);			
        mul_cl(l.outputs*l.batch, l.i_cl, 1, l.temp_cl, 1,0,0);				
        gradient_array_cl(l.g_cl, l.outputs*l.batch, TANH, l.temp_cl,0,0);		
        copy_cl(l.outputs*l.batch, l.temp_cl, 1, wg.delta_cl, 1,0,0);
        s.input_cl = l.prev_state_cl;
        s.delta_cl = l.dh_cl;														
        backward_connected_layer_cl(wg, s);	

        copy_cl(l.outputs*l.batch, l.temp_cl, 1, ug.delta_cl, 1,0,0);
        s.input_cl = state.input_cl;
        s.delta_cl = state.delta_cl;
        ...
        copy_cl(l.outputs*l.batch, l.temp2_cl, 1, l.temp_cl, 1,0,0);			
        mul_cl(l.outputs*l.batch, l.g_cl, 1, l.temp_cl, 1,0,0);				
        gradient_array_cl(l.i_cl, l.outputs*l.batch, LOGISTIC, l.temp_cl,0,0);	
        copy_cl(l.outputs*l.batch, l.temp_cl, 1, wi.delta_cl, 1,0,0);
        s.input_cl = l.prev_state_cl;
        s.delta_cl = l.dh_cl;
        backward_connected_layer_cl(wi, s);						

        copy_cl(l.outputs*l.batch, l.temp_cl, 1, ui.delta_cl, 1,0,0);
        s.input_cl = state.input_cl;
        s.delta_cl = state.delta_cl;
        backward_connected_layer_cl(ui, s);									

        copy_cl(l.outputs*l.batch, l.temp2_cl, 1, l.temp_cl, 1,0,0);		
        mul_cl(l.outputs*l.batch, l.prev_cell_cl, 1, l.temp_cl, 1,0,0);
        gradient_array_cl(l.f_cl, l.outputs*l.batch, LOGISTIC, l.temp_cl,0,0);
        copy_cl(l.outputs*l.batch, l.temp_cl, 1, wf.delta_cl, 1,0,0);
        s.input_cl = l.prev_state_cl;
        s.delta_cl = l.dh_cl;
        backward_connected_layer_cl(wf, s);						

        copy_cl(l.outputs*l.batch, l.temp_cl, 1, uf.delta_cl, 1,0,0);
        s.input_cl = state.input_cl;
        s.delta_cl = state.delta_cl;
        backward_connected_layer_cl(uf, s);									

        copy_cl(l.outputs*l.batch, l.temp2_cl, 1, l.temp_cl, 1,0,0);			
        mul_cl(l.outputs*l.batch, l.f_cl, 1, l.temp_cl, 1,0,0);				
        copy_cl(l.outputs*l.batch, l.temp_cl, 1, l.dc_cl, 1,0,0);				
