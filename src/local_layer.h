...
#endif
#ifdef OPENCL
void forward_local_layer_cl(local_layer layer, network net);
void backward_local_layer_cl(local_layer layer, network net);
void update_local_layer_cl(local_layer layer, update_args a);
