...
void forward_reorg_layer_cl(layer l, network net)
{
    ...
    if(l.flatten){
        if(l.reverse){
            flatten_cl(net.input_cl, l.w*l.h, l.c, l.batch, 0, l.output_cl,0,0);
        }else{
            flatten_cl(net.input_cl, l.w*l.h, l.c, l.batch, 1, l.output_cl,0,0);
        }
    } else if (l.extra) {
        for(i = 0; i < l.batch; ++i){
            copy_cl(l.inputs, net.input_cl, 1, l.output_cl, 1,i*l.inputs,i*l.outputs);
        }
    } else if (l.reverse) {
        reorg_cl(net.input_cl, l.w, l.h, l.c, l.batch, l.stride, 1, l.output_cl,0,0);
    }else {
        reorg_cl(net.input_cl, l.w, l.h, l.c, l.batch, l.stride, 0, l.output_cl,0,0);
    }
}
...
void backward_reorg_layer_cl(layer l, network net)
{
    if(l.flatten){
        if(l.reverse){
            flatten_cl(l.delta_cl, l.w*l.h, l.c, l.batch, 1, net.delta_cl,0,0);
        }else{
            flatten_cl(l.delta_cl, l.w*l.h, l.c, l.batch, 0, net.delta_cl,0,0);
        }
    } else if (l.extra) {
        int i;
        for(i = 0; i < l.batch; ++i){
            copy_cl(l.inputs, l.delta_cl, 1, net.delta_cl, 1,i*l.outputs,i*l.inputs);
        }
    } else if(l.reverse){
        reorg_cl(l.delta_cl, l.w, l.h, l.c, l.batch, l.stride, 0, net.delta_cl,0,0);
    } else {
        reorg_cl(l.delta_cl, l.w, l.h, l.c, l.batch, l.stride, 1, net.delta_cl,0,0);
    }
}
#endif