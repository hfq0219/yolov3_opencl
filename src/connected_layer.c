...
void pull_connected_layer(layer l)
{
    cl_pull_array(l.weights_cl, l.weights, l.inputs*l.outputs,0);
    cl_pull_array(l.biases_cl, l.biases, l.outputs,0);
    cl_pull_array(l.weight_updates_cl, l.weight_updates, l.inputs*l.outputs,0);
    cl_pull_array(l.bias_updates_cl, l.bias_updates, l.outputs,0);
    if (l.batch_normalize){
        cl_pull_array(l.scales_cl, l.scales, l.outputs,0);
        cl_pull_array(l.rolling_mean_cl, l.rolling_mean, l.outputs,0);
        cl_pull_array(l.rolling_variance_cl, l.rolling_variance, l.outputs,0);
    }
}

void push_connected_layer(layer l)
{
    cl_push_array(l.weights_cl, l.weights, l.inputs*l.outputs,0);
    cl_push_array(l.biases_cl, l.biases, l.outputs,0);
    cl_push_array(l.weight_updates_cl, l.weight_updates, l.inputs*l.outputs,0);
    cl_push_array(l.bias_updates_cl, l.bias_updates, l.outputs,0);
    if (l.batch_normalize){
        cl_push_array(l.scales_cl, l.scales, l.outputs,0);
        cl_push_array(l.rolling_mean_cl, l.rolling_mean, l.outputs,0);
        cl_push_array(l.rolling_variance_cl, l.rolling_variance, l.outputs,0);
    }
}
...
void update_connected_layer_cl(layer l, update_args a)
{
    ...
    int batch = a.batch;
    if(a.adam){
        adam_update_cl(l.weights_cl, l.weight_updates_cl, l.m_cl, l.v_cl, a.B1, a.B2, a.eps, decay, learning_rate, l.inputs*l.outputs, batch, a.t,0,0,0,0);
        adam_update_cl(l.biases_cl, l.bias_updates_cl, l.bias_m_cl, l.bias_v_cl, a.B1, a.B2, a.eps, decay, learning_rate, l.outputs, batch, a.t,0,0,0,0);
        if(l.scales_cl){
            adam_update_cl(l.scales_cl, l.scale_updates_cl, l.scale_m_cl, l.scale_v_cl, a.B1, a.B2, a.eps, decay, learning_rate, l.outputs, batch, a.t,0,0,0,0);
        }
    }else{
        axpy_cl(l.outputs, learning_rate/batch, l.bias_updates_cl, 1, l.biases_cl, 1,0,0);
        scal_cl(l.outputs, momentum, l.bias_updates_cl, 1,0);

        if(l.batch_normalize){
            axpy_cl(l.outputs, learning_rate/batch, l.scale_updates_cl, 1, l.scales_cl, 1,0,0);
            scal_cl(l.outputs, momentum, l.scale_updates_cl, 1,0);
        }

        axpy_cl(l.inputs*l.outputs, -decay*batch, l.weights_cl, 1, l.weight_updates_cl, 1,0,0);
        axpy_cl(l.inputs*l.outputs, learning_rate/batch, l.weight_updates_cl, 1, l.weights_cl, 1,0,0);
        scal_cl(l.inputs*l.outputs, momentum, l.weight_updates_cl, 1,0);
    }
}
...
void forward_connected_layer_cl(layer l, network net)
{
    ...
    gemm_cl(0,1,m,n,k,1,a,k,b,k,1,c,n,0,0,0);

    if (l.batch_normalize) {
        forward_batchnorm_layer_cl(l, net);
    } else {
        add_bias_cl(l.output_cl, l.biases_cl, l.batch, l.outputs, 1,0,0);
    }
...
{
    constrain_cl(l.outputs*l.batch, 1, l.delta_cl, 1,0);
    gradient_array_cl(l.output_cl, l.outputs*l.batch, l.activation, l.delta_cl,0,0);
    if(l.batch_normalize){
        backward_batchnorm_layer_cl(l, net);
    } else {
        backward_bias_cl(l.bias_updates_cl, l.delta_cl, l.batch, l.outputs, 1,0,0);
    }
    ...
    gemm_cl(1,0,m,n,k,1,a,m,b,n,1,c,n,0,0,0);
    ...
    if(c) gemm_cl(0,0,m,n,k,1,a,k,b,n,1,c,n,0,0,0);
}
#endif