...
void pull_batchnorm_layer(layer l)
{
    cl_pull_array(l.scales_cl, l.scales, l.c,0);
    cl_pull_array(l.rolling_mean_cl, l.rolling_mean, l.c,0);
    cl_pull_array(l.rolling_variance_cl, l.rolling_variance, l.c,0);
}
void push_batchnorm_layer(layer l)
{
    cl_push_array(l.scales_cl, l.scales, l.c,0);
    cl_push_array(l.rolling_mean_cl, l.rolling_mean, l.c,0);
    cl_push_array(l.rolling_variance_cl, l.rolling_variance, l.c,0);
}
void forward_batchnorm_layer_cl(layer l, network net)
{
    if(l.type == BATCHNORM) copy_cl(l.outputs*l.batch, net.input_cl, 1, l.output_cl, 1,0,0);
    copy_cl(l.outputs*l.batch, l.output_cl, 1, l.x_cl, 1,0,0);
    if (net.train) {
        fast_mean_cl(l.output_cl, l.batch, l.out_c, l.out_h*l.out_w, l.mean_cl,0,0);
        fast_variance_cl(l.output_cl, l.mean_cl, l.batch, l.out_c, l.out_h*l.out_w, l.variance_cl,0,0,0);

        scal_cl(l.out_c, .99, l.rolling_mean_cl, 1,0);
        axpy_cl(l.out_c, .01, l.mean_cl, 1, l.rolling_mean_cl, 1,0,0);
        scal_cl(l.out_c, .99, l.rolling_variance_cl, 1,0);
        axpy_cl(l.out_c, .01, l.variance_cl, 1, l.rolling_variance_cl, 1,0,0);

        copy_cl(l.outputs*l.batch, l.output_cl, 1, l.x_cl, 1,0,0);
        normalize_cl(l.output_cl, l.mean_cl, l.variance_cl, l.batch, l.out_c, l.out_h*l.out_w,0,0,0);
        copy_cl(l.outputs*l.batch, l.output_cl, 1, l.x_norm_cl, 1,0,0);

        scale_bias_cl(l.output_cl, l.scales_cl, l.batch, l.out_c, l.out_h*l.out_w,0,0);
        add_bias_cl(l.output_cl, l.biases_cl, l.batch, l.out_c, l.out_w*l.out_h,0,0);
    } else {
        normalize_cl(l.output_cl, l.rolling_mean_cl, l.rolling_variance_cl, l.batch, l.out_c, l.out_h*l.out_w,0,0,0);
        scale_bias_cl(l.output_cl, l.scales_cl, l.batch, l.out_c, l.out_h*l.out_w,0,0);
        add_bias_cl(l.output_cl, l.biases_cl, l.batch, l.out_c, l.out_w*l.out_h,0,0);
    }
}
void backward_batchnorm_layer_cl(layer l, network net)
{
    ...
    backward_bias_cl(l.bias_updates_cl, l.delta_cl, l.batch, l.out_c, l.out_w*l.out_h,0,0);
    backward_scale_cl(l.x_norm_cl, l.delta_cl, l.batch, l.out_c, l.out_w*l.out_h, l.scale_updates_cl,0,0,0);

    scale_bias_cl(l.delta_cl, l.scales_cl, l.batch, l.out_c, l.out_h*l.out_w,0,0);

    fast_mean_delta_cl(l.delta_cl, l.variance_cl, l.batch, l.out_c, l.out_w*l.out_h, l.mean_delta_cl,0,0,0);
    fast_variance_delta_cl(l.x_cl, l.delta_cl, l.mean_cl, l.variance_cl, l.batch, l.out_c, l.out_w*l.out_h, l.variance_delta_cl,0,0,0,0,0);
    normalize_delta_cl(l.x_cl, l.mean_cl, l.variance_cl, l.mean_delta_cl, l.variance_delta_cl, l.batch, l.out_c, l.out_w*l.out_h, l.delta_cl,0,0,0,0,0,0);

    if(l.type == BATCHNORM) copy_cl(l.outputs*l.batch, l.delta_cl, 1, net.delta_cl, 1,0,0);
}
#endif