...
void forward_crnn_layer_cl(layer l, network net)
{
    ...
    fill_cl(l.hidden * l.batch * l.steps, 0, self_layer.delta_cl, 1,0);
    fill_cl(l.hidden * l.batch * l.steps, 0, input_layer.delta_cl, 1,0);
    if(net.train) fill_cl(l.hidden * l.batch, 0, l.state_cl, 1,0);
    ...
    for (i = 0; i < l.steps; ++i) {
        ...
        if(l.shortcut){
            copy_cl(l.hidden * l.batch, old_state, 1, l.state_cl, 1,0,0);
        }else{
            fill_cl(l.hidden * l.batch, 0, l.state_cl, 1,0);
        }
        axpy_cl(l.hidden * l.batch, 1, input_layer.output_cl, 1, l.state_cl, 1,0,0);
        axpy_cl(l.hidden * l.batch, 1, self_layer.output_cl, 1, l.state_cl, 1,0,0);
...
void backward_crnn_layer_cl(layer l, network net)
{
    ...
    for (i = l.steps-1; i >= 0; --i) {
        copy_cl(l.hidden * l.batch, input_layer.output_cl, 1, l.state_cl, 1,0,0);
        axpy_cl(l.hidden * l.batch, 1, self_layer.output_cl, 1, l.state_cl, 1,0,0);
        ...
        copy_cl(l.hidden*l.batch, self_layer.delta_cl, 1, input_layer.delta_cl, 1,0,0);
        if (i > 0 && l.shortcut) axpy_cl(l.hidden*l.batch, 1, self_layer.delta_cl, 1, self_layer.delta_cl, 1,0,-l.hidden*l.batch);
