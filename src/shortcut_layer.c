...
void forward_shortcut_layer_cl(const layer l, network net)
{
    ...
    shortcut_cl(l.batch, l.w, l.h, l.c, net.layers[l.index].output_cl, l.out_w, l.out_h, l.out_c, l.alpha, l.beta, l.output_cl,0,0);
...
void backward_shortcut_layer_cl(const layer l, network net)
{
    ...
    axpy_cl(l.outputs*l.batch, l.alpha, l.delta_cl, 1, net.delta_cl, 1,0,0);
    shortcut_cl(l.batch, l.out_w, l.out_h, l.out_c, l.delta_cl, l.w, l.h, l.c, 1, l.beta, net.layers[l.index].delta_cl,0,0);
}
#endif